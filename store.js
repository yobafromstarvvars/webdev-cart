...
function quantityChanged(event) {
    ...
    if (isNaN(quantityValue.value) || quantityValue.value < 1) {
...
function addItemToCart(title, price, imageSrc) {
    ...
    cardRow.getElementsByClassName('btn-danger')[0].addEventListener('click', removeCartItemClicked)
...
function updateCartTotal() {
    ...
    var totalLabel = document.getElementsByClassName('cart-total-price')[0]
